...
res6: String = eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzUxMiJ9.eyJleHAiOjE1NTAwMjAyNjQsImlhdCI6MTU1MDAyMDI1NCwidXNlciI6MX0.AHoHK2DEMvW0KSiM6OUKtvJ1pyyHiFdotftZf-UkfvzWOoigWZ9O1_QLr_aBMUDyY7XpNr4Fr_S4D14-WGuLTw
...
res33: scala.util.Try[String] = Failure(pdi.jwt.exceptions.JwtNotBeforeException: The token will only be valid after 2019-02-13T01:11:00Z)
```
...
pdi.jwt.exceptions.JwtNotBeforeException: The token will only be valid after 2019-02-13T01:11:01Z
...
java.lang.IllegalArgumentException: Input byte[] should at least have 2 bytes for base64 bytes
  at java.base/java.util.Base64$Decoder.outLength(Base64.java:659)
  at java.base/java.util.Base64$Decoder.decode(Base64.java:525)
...
expiredToken: String = eyJhbGciOiJub25lIn0.eyJpc3MiOiJtZSIsImV4cCI6MTU1MDAyMDI1NX0.
...
res54: scala.util.Try[String] = Failure(pdi.jwt.exceptions.JwtExpirationException: The token is expired since 2019-02-13T01:10:55Z)
...
res57: scala.util.Try[String] = Success({"iss":"me","exp":1550020255})
```
...
res60: scala.util.Try[String] = Success({"iss":"me","exp":1550020255})
```
